...
export function judgePrompt(taskDef, aText, bText) {
  ...
  return [
    ...
    'Do NOT use any tools, open any files, or explore the workspace — the two outputs below are the ONLY evidence you may consider.',
    '',
    `TASK: ${taskDef.name}\n${taskDef.prompt}`,
    '',
    `RUBRIC:\n${rubric}`,
    ...
    bText.slice(0, 30000),
    '',
    'Reply with EXACTLY one JSON object, no other text, no preamble, no commentary:',
