...
fn no_database_control_commands_use_only_canonical_address_environment_names() {
    for argument in ["preflight", "owner-plan"] {
        ...
        assert!(
            deprecated_error.contains("required environment is missing: WALLET_ADDRESS"),
        ...
        assert!(
            wallet_error.contains("required environment is missing: EXECUTOR_ADDRESS"),
        ...
        assert!(
            canonical_error.contains("required environment is missing: PRODUCTION_RPC_URL"),
