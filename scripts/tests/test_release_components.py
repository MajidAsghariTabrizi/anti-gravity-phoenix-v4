...
class ReleaseComponentRegistryTests(unittest.TestCase):
    ...
    def test_workflows_use_registry_and_main_push_runs_all_required_jobs(self) -> None:
        ...
        self.assertIn("PHOENIX_RELEASE_IMAGE_SET: legacy", build)
        self.assertIn("PHOENIX_RELEASE_IMAGE_SET: legacy", controller)
        self.assertNotIn("PHOENIX_RELEASE_IMAGE_SET: current", build)
        self.assertNotIn("PHOENIX_RELEASE_IMAGE_SET: current", controller)
