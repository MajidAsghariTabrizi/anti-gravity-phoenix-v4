...
| Read the engineering research | [`docs/engineering-notes/README.md`](engineering-notes/README.md) |
| Inspect a specific design decision | The relevant file under [`docs/engineering-notes/`](engineering-notes/) |
| Run the system locally | [`README.md` § Local Operations](../README.md) and `.env.example` |
| Audit the production safety model | [`docs/SECURITY.md`](SECURITY.md), [`docs/RELEASE_AND_ROLLBACK.md`](RELEASE_AND_ROLLBACK.md) |
| Propose a public engineering question | [`docs/engineering-notes/discussions/`](engineering-notes/discussions/) (when Discussions are enabled) |
...
- Email the address listed in [`docs/SECURITY.md`](SECURITY.md), or use GitHub's private vulnerability-reporting flow once the repository's security policy is fully published.
