...
5. Use the architecture, safety, release, and contracts links above for technical specification-level depth.
6. Use the engineering-notes cross-references into the source — every note cites specific Phoenix source files for the design being discussed.