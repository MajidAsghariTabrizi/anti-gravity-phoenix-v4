...
var defaultCounters = []string{
	...
	"feed_jetstream_publish_ack_timeout_retries_total",
	"feed_jetstream_publish_recovered_normal_total",
	"feed_jetstream_publish_recovered_duplicate_total",
	"feed_jetstream_publish_retry_exhausted_total",
